...
wd
  ...
  <tr>
    <td style="width:5%"></td>
    <td>The purpose of this model is to represent the annotations produced during the development of a building renovation project. These annotations inform about issues found during during the renovation activities or missing information not gathered during the surveying process that could be relevant for the project, such as missing building components.</td>
  </tr>
  ...
  <tr>
    <td style="width:5%"></td>
    <td>The scope of this ontology is limited to the annotations data shared through the BIF.</td>
  </tr>
  ...
  <tr>
    <td style="width:5%"></td>
    <td>Exchange of data about annotations and issues send through BIF.</td>
  </tr>
...
<tr>
  ...
  <tr>
    <td style="width:5%"></td>
    <td>The whole set of functional requirements is located <a href="https://github.com/oeg-upm/bimerr-annotation-objects/blob/master/requirements">here</a> </td>
  </tr>
